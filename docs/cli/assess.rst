...
.. rubric:: Scope to Specific Zones with HTML Output
...
.. rubric:: Run Only DNS and SSL Checks
...
.. code-block:: bash
    ...
    flareinspect assess --token $CLOUDFLARE_TOKEN --checks dns,ssl




.. rubric:: CI/CD Pipeline with Threshold Gate
...
.. rubric:: Compliance Assessment (CIS Benchmark)
...
.. code-block:: bash
    ...
    flareinspect assess --token $CLOUDFLARE_TOKEN \
      ...
      --compliance cis -o cis-report.json
