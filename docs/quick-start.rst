...
.. rubric:: SARIF (for GitHub Advanced Security)
...
.. rubric:: CSV (for spreadsheet analysis)
...
Other supported formats: ``json``, ``markdown``, ``ocsf``, ``asff``. See :doc:`export command <export>` for details.
